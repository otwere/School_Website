      ...
      <div id="schoolvalues" className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="relative group">
            ...
            <div className="relative bg-gray-50 p-8 rounded-lg shadow-lg">
              <div className="flex items-center justify-center w-16 h-16 bg-blue-50 rounded-full mb-6 mx-auto">
                <Target className="w-8 h-8 text-blue-600" />
              </div>
              <h3 className="text-2xl font-bold text-center mb-4 hover:text-blue-500">
                Our Vision
              </h3>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gray-50 p-8 rounded-lg shadow-lg">
              ...
              <h3 className="text-2xl font-bold text-center mb-4 hover:text-green-500">
                Our Mission
              </h3>
              <p className="text-gray-600 text-center">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white p-8 rounded-lg shadow-lg">
              ...
              <h3 className="text-2xl font-bold text-center mb-4 hover:text-amber-500">Our Motto</h3>
              <p className="text-gray-600 text-center">
